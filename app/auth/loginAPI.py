...
class LoginAPI(MethodView):
    ...
    def post(self):
        try:
            ...
            user_id = self.all_users.fetch_one_by_email_and_password(request_body['email'],request_body['password'])
            ...
            resp = jsonify({'status': 'fail', 'code': 'ERR_UNAUTHORISED', 'message': e.message})
